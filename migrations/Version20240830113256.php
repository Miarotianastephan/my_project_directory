...
final class Version20240830113256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void{
        ...
        $this->addSql('ALTER TABLE DETAIL_DEMANDE_PIECE MODIFY (det_dm_date DATE DEFAULT NULL)');
    ...
    public function down(Schema $schema): void{
        ...
        $this->addSql('ALTER TABLE detail_demande_piece MODIFY (DET_DM_DATE DATE DEFAULT \'SYSDATE\')');
    }
